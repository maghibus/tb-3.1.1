...
@Data
public class MultipleCustomerInfo {
    private String customerTitle;
    private boolean customerIsPublic;
    private CustomerId customerId;

    public MultipleCustomerInfo(){

    }

    public MultipleCustomerInfo(String customerTitle, Object customerAdditionalInfo, UUID customerId){
