...
@RuleNode(
        ...
        name = "web service",
        configClazz = TbWSApiCallNodeConfiguration.class,
...
public class TbWSApiCallNode implements TbNode {
    ...
    private TbWSApiCallNodeConfiguration config;
    ...
    public void init(TbContext ctx, TbNodeConfiguration configuration) throws TbNodeException {
        try {
            this.config = TbNodeUtils.convert(configuration, TbWSApiCallNodeConfiguration.class);
    ...
    private TbMsg processResponse(TbContext ctx, TbMsg origMsg, ResponseEntity<String> response) {
        ...
        try {
            ...
            JSONObject jsonBody = XML.toJSONObject(newBody);
            stringBody = jsonBody.toString();
        } catch (Exception e) {
            log.warn(e.getMessage());
        }

        return ctx.transformMsg(origMsg, origMsg.getType(), origMsg.getOriginator(), metaData, stringBody);
    }
