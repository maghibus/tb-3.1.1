 ...
 */
@Data
public class TbKafkaNodeSSLConfiguration implements NodeConfiguration<TbKafkaNodeSSLConfiguration> {
    ...
    @Override
    public TbKafkaNodeSSLConfiguration defaultConfiguration() {
        TbKafkaNodeSSLConfiguration configuration = new TbKafkaNodeSSLConfiguration();
