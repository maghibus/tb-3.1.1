...
@RuleNode(
        ...
        relationTypes = {"Post attributes", "Post telemetry", "RPC Request from Device", "RPC Request to Device", "Activity Event", "Inactivity Event",
                ...
                "Entity Unassigned", "Attributes Updated", "Attributes Deleted", "Alarm Acknowledged", "Alarm Cleared", "Rule Engine API Request", "Other", "Entity Assigned From Tenant", "Entity Assigned To Tenant"},
...
public class TbMsgTypeSwitchNode implements TbNode {
    ...
    public void onMsg(TbContext ctx, TbMsg msg) {
        ...
        } else if (msg.getType().equals(DataConstants.RULE_ENGINE_API_REQUEST)) {
            relationType = "Rule Engine API Request";
        } else {
            relationType = "Other";
        }
